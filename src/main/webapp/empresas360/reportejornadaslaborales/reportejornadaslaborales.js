...
/*const botonRegresarJornadasLaborales = async () => {
...
$("#tab_en_jornada").mouseover(() => {
    ...
    //$("#tab_reporte_empleado").removeClass("active");
    //$("#tab_tabla_empleado").removeClass("active");
});
...
/*$("#tab_reporte_empleado").mouseover(() => {
 $("#tab_reporte_jornada").removeClass("active");
 $("#tab_en_jornada").removeClass("active");
 $("#tab_reporte_empleado").addClass("active");
 $("#tab_tabla_empleado").removeClass("active");
 });*/
/*$("#tab_tabla_empleado").mouseover(() => {
 $("#tab_reporte_jornada").removeClass("active");
 $("#tab_en_jornada").removeClass("active");
 //$("#tab_reporte_empleado").removeClass("active");
 $("#tab_tabla_empleado").addClass("active");
 });*/
var empleados = [],
        empleadosEmpresa = [],
        tablaInicio;
            ...
            case "EMPLEADO":
                ...
                if (empleado === null || empleado === undefined || empleado === "") {
                    ...
                    /*response = {
                     ...
                     "id360": null,
                     "urlServicio": "https://empresas.claro360.com/plataforma360",
                     "reporte": "se reemplazaron las peticiones simuladas y se agregaron peticiones directas al servidor en las jornadas laborales",
                     "tipo_area": "463",
                     "web": "true",
                     "time_created": "08:56:42",
                     "id": "1637",
                     "tipo_usuario": "124",
                     "lat": null,
                     "apikey": "46908144",
                     "lng": null,
                     "date_created": "2021-02-02",
                     "id_socket": "56047b54-34f2-4740-899d-dc98fb225b34",
                     "contadorDesconexion": "7",
                     "time_updated": "19:09:23",
                     "idsesion": "2_MX40NjkwODE0NH5-MTYxMjMwMjkwMTY5OH5VSSt0cjVjNlFpZVhMSFd3dnJBQlFQMUR-fg",
                     "token": "T1==",
                     "id_usuario": "9991337113",
                     "time_finished": "19:09:23",
                     "tipo_servicio": "3064",
                     "activo": "0"
                     },
                     {
                     ...
                     "id360": null,
                     "urlServicio": "https://empresas.claro360.com/plataforma360",
                     "reporte": " agregue comunicación y dinamismo en mostrar al empleado en jornadas laborales de acuerdo a su id.",
                     "tipo_area": "463",
                     "web": "true",
                     "time_created": "08:57:43",
                     "id": "1696",
                     "tipo_usuario": "124",
                     "lat": null,
                     "apikey": "46908164",
                     "lng": null,
                     "date_created": "2021-02-03",
                     "id_socket": "aab63f2c-46c1-408e-92f4-c8b15758d507",
                     "contadorDesconexion": "7",
                     "time_updated": "19:23:21",
                     "idsesion": "2_MX40NjkwODE2NH5-MTYxMjM4OTI3ODUwNX42bG41UHdialZ6dkhoa0xyMHA4RDA0WEV-fg",
                     "token": "T1==",
                     "id_usuario": "9991337113",
                     "time_finished": "19:23:21",
                     "tipo_servicio": "3064",
                     "activo": "0"
                     },
                     {
                     ...
                     "id360": null,
                     "urlServicio": "https://empresas.claro360.com/plataforma360",
                     "reporte": "optimización de tablas y diseño en jornadas laborales.",
                     "tipo_area": "463",
                     "web": "true",
                     "time_created": "08:57:12",
                     "id": "1751",
                     "tipo_usuario": "124",
                     "lat": null,
                     "apikey": "46908204",
                     "lng": null,
                     "date_created": "2021-02-04",
                     "id_socket": "88a2a4df-1f73-484b-9b12-feb3a033dc90",
                     "contadorDesconexion": "7",
                     "time_updated": "19:26:18",
                     "idsesion": "2_MX40NjkwODIwNH5-MTYxMjQ3NTkwOTg2OX52NDZmVDl6Q3lQaFFlcHV0MWVINUYwVFp-fg",
                     "token": "T1==",
                     "id_usuario": "9991337113",
                     "time_finished": "19:26:18",
                     "tipo_servicio": "3064",
                     "activo": "0"
                     },
                     {
                     ...
                     "id360": null,
                     "urlServicio": "https://empresas.claro360.com/plataforma360",
                     "reporte": " reunión para presentar avances en jornada laboral a nivel empresa.",
                     "tipo_area": "463",
                     "web": "true",
                     "time_created": "08:58:07",
                     "id": "1804",
                     "tipo_usuario": "124",
                     "lat": null,
                     "apikey": "46908214",
                     "lng": null,
                     "date_created": "2021-02-05",
                     "id_socket": "6a112d20-0518-4b63-b4bc-72eb533900f9",
                     "contadorDesconexion": "7",
                     "time_updated": "19:02:15",
                     "idsesion": "1_MX40NjkwODIxNH5-MTYxMjU3MDQ2OTE5OX5nUFloZzBMTTBncVBGS201eThSV0ZidHd-fg",
                     "token": "T1==",
                     "id_usuario": "9991337113",
                     "time_finished": "19:02:15",
                     "tipo_servicio": "3064",
                     "activo": "0"
                     }
                     ],
